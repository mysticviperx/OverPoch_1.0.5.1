...
_refuel_costs = [["AllVehicles",["ItemGoldBar",2]]]; // 2 Gold for all vehicles (equal to [["AllVehicles",[]]])
...
_repair_costs = [
	["Air",["ItemGoldBar10oz",5]], // 5 10oz Gold for helicopters and planes
	["AllVehicles",["ItemGoldBar10oz",2]] // 2 10oz Gold for all other vehicles
];
