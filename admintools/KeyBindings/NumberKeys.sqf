...
*/
Sleep 10;
 1_KEY = (findDisplay 46) displayAddEventHandler ["KeyDown","if ((_this select 1) == 79) then {[] execVM ""admintools\tools\Teleport\Teleport.sqf"";};"];
Sleep 0.02;
...
Sleep 0.02;
 4_KEY = (findDisplay 46) displayAddEventHandler ["KeyDown","if ((_this select 1) == 75) then {[] execVM ""admintools\tools\Teleport\TPtoME.sqf"";};"];
Sleep 0.02;
...
Sleep 0.02;
 7_KEY = (findDisplay 46) displayAddEventHandler ["KeyDown","if ((_this select 1) == 71) then {[] execVM ""admintools\tools\Teleport\TpToPlayer.sqf"";};"];
Sleep 0.02;
...
F10_KEY = (findDisplay 46) displayAddEventHandler ["KeyDown","if ((_this select 1) == 55) then {toolsAreActive=true;};"];
Sleep 0.02;
// Used to toggle admin scroll menu OFF
F11_KEY = (findDisplay 46) displayAddEventHandler ["KeyDown","if ((_this select 1) == 83) then {toolsAreActive=false;};"];
